...
export const getLearningPlans = () => api.get("/learningplans/my");
export const createLearningPlan = (plan) => api.post("/learningplans", plan);
export const updateLearningPlan = (planId, plan) =>
  api.put(`/learningplans/${planId}`, plan);
export const deleteLearningPlan = (planId) =>
  api.delete(`/learningplans/${planId}`);
=======
import axios from 'axios';
...
export const followUser = (userId) => api.post(`/users/follow/${userId}`);
export const unfollowUser = (userId) => api.post(`/users/unfollow/${userId}`);
>>>>>>> eaee74c737381a5fc06a06e9f097c81a520e1588
